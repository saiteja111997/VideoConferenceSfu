...
func Room(c *fiber.Ctx) error {
	...
	//Rendering main.html using fiber
...
// CREATES A ROOM IF THERE IS NONE ELSE RETURNS AN EXISTING ROOM
func createOrGetRoom(uuid string) (string, string, *w.Room) {
	...
	// RUNNNING THE CHAT HUB ON THE SAME CONNECTION AS THE ROOM URL
	go hub.Run()
	return uuid, suuid, room
}
